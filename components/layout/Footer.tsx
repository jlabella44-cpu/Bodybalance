...
const quickLinks = [
  ...
  { href: "/services/bhrt", label: "Hormone Therapy" },
...
export default function Footer() {
  return (
    ...
    >
      {/* Main footer grid */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
        ...
        <div>
          ...
          <p className="text-warm-white/70 text-sm leading-relaxed">
            Your path to hormonal balance.<br />
        ...
        <div>
          ...
          <address className="not-italic text-sm text-warm-white/70 space-y-3">
            <p>
      ...
      <div className="border-t border-warm-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-warm-white/40">
          <p>© {new Date().getFullYear()} Body Balance. All rights reserved.</p>
          <p>1311 Wakarusa Dr Ste 2121, Lawrence, KS 66049</p>
        </div>
      </div>
    </footer>
  );
