  ...
  return (
    <section className="relative pt-32 pb-20 bg-forest overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="flex items-center gap-2 text-xs text-warm-white/40 mb-8" style={{ fontFamily: "var(--font-sans)" }} aria-label="Breadcrumb">
          ...
          <span>/</span>
          <span className="text-warm-white/60">Weight Management</span>
        </nav>
        ...
        >
          Medical Weight Management in Lawrence, KS
        </h1>
        <p className="text-lg text-warm-white/80 leading-relaxed max-w-3xl mb-10" style={{ fontFamily: "var(--font-sans)" }}>
          If you&apos;ve tried diet and exercise and still can&apos;t move the needle, it&apos;s probably not a willpower problem.
          Hormonal imbalances, metabolic resistance, and insulin dysregulation all make weight loss biologically harder.
          At Body Balance in Lawrence, KS, we address those root causes — using GLP-1/GIP protocols, metabolic optimization,
          and personalized plans built around your labs, not a template.
        </p>
